...
<head>
    ...
    <link    rel="stylesheet"                     href="css/fontawesome.min.css"><!--Ícones relacionados aos botões e ao menu-->    
    ...
    <body>    
        ...
        <div class="d-flex">
            ...
            <li class='active'><a href='index.php'><i class='fas fa-tachometer-alt'></i> Home</a></li>
